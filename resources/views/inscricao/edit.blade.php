                                                ...
                                                <div class="card-header">
                                                    ...
                                                    <div class="form-group">
                                                        <div class="alert alert-danger" role="alert">
                                                            <center>
                                                                <h4 class="alert-heading">Nome da Receita: </h4>
                                                            </center>
                                                            <p class="text-center"> <b> {{ $recibo->Nome_Prato }} </b></p>
                                                            <center>
                                                                <h4 class="alert-heading">Motivo da Receita: </h4>
                                                            </center>
                                                                                            ...
                                                                                            <div class="card-body">
                                                                                                ...
                                                                                                <div
                                                                                                    ...
                                                                                                    <div
                                                                                                        ...
                                                                                                        {!! Form::model($recibo, ['method' => 'PATCH', 'route' => ['inscricao_update', $recibo->id], 'enctype' => 'multipart/form-data']) !!}
